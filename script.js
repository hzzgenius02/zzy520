...
noButton.addEventListener("click", function () {
    ...
    // 图片变化（前 5 次变化）
    // 震惊 修改为绝对路径
    if (clickCount === 1) mainImage.src = "./images/2.gif";  
    // 思考 修改为绝对路径  
    if (clickCount === 2) mainImage.src = "./images/3.gif";  
    // 生气 修改为绝对路径  
    if (clickCount === 3) mainImage.src = "./images/4.gif"; 
    // 哭 修改为绝对路径    
    if (clickCount === 4) mainImage.src = "./images/5.gif";   
    // 之后一直是哭
    if (clickCount >= 5) mainImage.src = "./images/5.gif";
...
yesButton.addEventListener("click", function () {
    document.body.innerHTML = `
        <div class="yes-screen">
            ...
            <img src="./images/6.gif" alt="拥抱" class="yes-image">   
        </div>
    `;
